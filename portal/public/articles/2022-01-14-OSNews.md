...
The RConsortium is running various working groups and maintain webinars about ["The R Adoption Series"](https://r-consortium.org/webinars/webinars.html). There had been a nice overview of "R Consortium Pharma Working Groups Overview and Updates" which is available as [recording](https://www.youtube.com/watch?v=oTjeYOrrTOY) from the R in Pharma conference.
...
The "Submissions" team focus on IT and platform challenges that must be addressed in order to make "all R" regulatory submissions. This group was able to successfully submit an R-based test submission package to FDA eCTD gateway on 22. November 2021 ([blog](https://web.archive.org/web/20220119043854/https://www.r-consortium.org/blog/2021/12/08/successful-r-based-test-package-submitted-to-fda)).
...
* R Package Validation at Roche ([link](https://raw.githubusercontent.com/pharmaR/case_studies/fa5e4c82098266fe7516adaa8671a64c9796a0e3/Roche_Rpkg_validation_2022.pdf))
* R Package Validation at Merck ([link](https://raw.githubusercontent.com/pharmaR/case_studies/fa5e4c82098266fe7516adaa8671a64c9796a0e3/Merck_KGaA_Rpkg_validation_220202.pdf), [link](https://raw.githubusercontent.com/pharmaR/case_studies/fa5e4c82098266fe7516adaa8671a64c9796a0e3/External%20R%20Package%20Qualification%20Implementation%20at%20Merck.pdf))
* R Harmonization at Pfizer (link no longer available)
* End to End Toolkit (GSK, Atorus) (link no longer available)
